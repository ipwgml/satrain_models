#!/usr/bin/env python3
"""
Script for training a generic dense encoder-decoder (UNet++)  model on the
SatRain dataset.
"""
import argparse
import logging
...
from satrain_models.unetpp import DenseEncoderDecoder
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Train DenseEncoderDecoder model")
