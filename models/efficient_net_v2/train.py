...
from satrain_models import (
    ...
    SatRainDataModule, tensorboard_to_netcdf, ComputeConfig, EfficientNetV2Config
)
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Train EfficientNetV2 model")
    ...
    model_config = EfficientNetV2Config.from_toml_file(model_config_path)
    ...
    dataset_prefix = config.get_experiment_name_prefix("efficient_net_v2")
